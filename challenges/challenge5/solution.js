(function() {
  ...
  d3.json("data/eu.geojson", function(data) {
    ...
    country = countries.selectAll('.country').data(data.features).enter().append('path').attr('class', 'country').attr('d', path);
    countries.selectAll('.subuni-label').data(data.features).enter().append("text").attr("class", function(d) {
